 ...
 * This includes code from the FIRST library (C) Qualcomm as of 10/13/2017
 */
public abstract class JewelsLinearVisionOpMode extends JewelsVisionOpMode {
    ...
    public JewelsLinearVisionOpMode() {
    }
    ...
    protected class LinearOpModeHelper implements Runnable {
        ...
        public void run() {
            ThreadPool.logThreadLifeCycle("LinearOpMode main", new Runnable() { @Override public void run() {
                ...
                try {
                    JewelsLinearVisionOpMode.this.runOpMode();
                    requestOpModeStop();
    ...
    private static class Threader implements Runnable {
        private final JewelsLinearVisionOpMode opModeReference;
        private RuntimeException lastError = null;
        private boolean ready = false;

        public Threader(JewelsLinearVisionOpMode var1) {
